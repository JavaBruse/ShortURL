...
Автоматическое удаление ссылки реализовано в этом методе:
```java
...
В коде нет проверки на уникальность длинных ссылок, на любые одинаковые ссылки, будет выдана новая коротка ссылка. 
